...
export default function UseCasesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 animate-fade-up">
      ...
      {/* Breadcrumb */}
      <div className="flex items-center gap-1.5 text-xs mb-6 flex-wrap" style={{ color: '#8892A8' }}>
      ...
      <div className="flex items-start gap-4 mb-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            <span className="text-xs" style={{ color: '#8892A8' }}>{totalUseCases} total &middot; {totalStories} with User Stories</span>
          </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <span className="text-xs leading-snug block group-hover:text-[#072A6C] transition-colors" style={{ color: '#6B7589' }}>
                                  {uc.label}
                                </span>
                                <div className="flex flex-wrap gap-1 mt-1.5">
                                  ...
                                  {tags.map(tag => (
                                    <span key={tag} className="badge" style={{ color: '#8892A8', background: 'rgba(7,42,108,0.04)' }}>
                                      {tag}
                                    </span>
                                  ))}
                                </div>
